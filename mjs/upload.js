		...
		if (oReq.status == 200) {
			for (var i=1; i<=4; i++)
			{
				if (parent.document.getElementById('Image'+i).value == '' )
				{
					...
					parent.document.getElementById('Image'+i+'Box').innerHTML='<img src='+oReq.responseText+' width=78 height=78 border=0 onload=DrawImage(this,78,78) /><a href=javascript:DeleteImage(\'Image'+i+'\')  class=\'btn_delete\'>'+DeleteLabel+'</a>';
					break;
				}
			}
		} else { 
