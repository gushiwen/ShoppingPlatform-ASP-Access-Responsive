...
If Gettime <> "" Then
TempMailContent=TempMailContent & "Expected Delivery time: " & Gettime & "<br>"
End If 
...
If CompPhone <> "" Then
TempMailContent=TempMailContent & "Other Contact Number: " & CompPhone & "<br>"
End If 
...
If Notes <> "" Then
TempMailContent=TempMailContent & "<br>Other Requirements: <br>" &   Notes & "<br><br>"
End If 
...
response.write "alert('We have received your order, please arrange payment, thank you!');"
