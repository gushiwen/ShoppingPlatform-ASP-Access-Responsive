...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		// my_prod.asp设置category
		function  SelectCategory(LarCode,MidCode,enLarCode,enMidCode) 
		{	
			if (LarCode!="" && MidCode!="" && enLarCode!="" && enMidCode!="")
			{
			...
			window.opener.document.getElementById('Category1').value = Category1;
			window.close();
		}
		</script>
	</head>
		...
		<div id="nav" class="navfull">
			<div class="area clearfix">
				<div class="category-content" id="guide_2">
					<div class="long-title"><span class="all-goods">Category</span><span id="meauBack"><a href="javascript:window.close();">Back</a></span></div>
					<div class="category">
													...
													<div class="area-in">
														<div class="area-bg">
															<div class="menu-srot">
																<div class="sort-side">
																	<ul class="ul-sort">
																		<li class="li-sort"><a class="larcode" title="<%=rs("enLarCode")%>" href="#"><span><%=rs("enLarCode")%></span></a></dt>
																		<%
																		...
																		%>
																		<li class="li-sort"><a class="midcode" title="<%=rsm("enMidCode")%>" href="javascript:SelectCategory('<%=rsm("LarCode")%>','<%=rsm("MidCode")%>','<%=rsm("enLarCode")%>','<%=rsm("enMidCode")%>')"><span><%=rsm("enMidCode")%></span></a></dd>
																		<%
  																				rsm.movenext
  																			loop
  																			rsm.close
