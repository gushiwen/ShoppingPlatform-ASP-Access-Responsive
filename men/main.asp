...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="banner">
			...
			<ul class="am-slides">
				<li class="banner1"><a href="<%=pic1_lnk%>"><img src="<%=pic1%>" /></a></li>
				<li class="banner2"><a href="<%=pic2_lnk%>"><img src="<%=pic2%>" /></a></li>
				<li class="banner3"><a href="<%=pic3_lnk%>"><img src="<%=pic3%>" /></a></li>
				<li class="banner4"><a href="<%=pic4_lnk%>"><img src="<%=pic4%>" /></a></li>
			</ul>
			</div>
			<div class="clear"></div>	
		</div>
